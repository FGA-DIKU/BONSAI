...
def set_dates(date_type: Literal["relative", "absolute"], outcome_dates: Optional[pd.Series]=None, hour_shift: Optional[int]=None, date: Optional[Dict[str, int]]=None):
    if date_type == "relative":
        ...
        raise ValueError(f"Date_type only allowed to be [relative, absolute], not {date_type}")
