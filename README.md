...
2. Pretrain model. 
`python bonsai/run/pretrain.py --config-name pretrain dataset=correlated_MEDS_data`
...
4. Finetune model.
`python bonsai/run/finetune.py --config-name finetune dataset=correlated_MEDS_data outcome=examples/example_outcome1 pretrain_path=/path/to/your/pretrained/checkpoints/best.ckpt`
...
5. Train model.
`python bonsai/run/train.py --config-name finetune dataset=correlated_MEDS_data outcome=examples/example_outcome1`
